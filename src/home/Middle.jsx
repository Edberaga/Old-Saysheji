    ...
    <section className='my-20 '>
      ...
      <div className="w-full flex justify-between items-start md:flex-row flex-col sm:mb-0 mb-6 relative z-[1]">
        <div className="w-full md:mt-10 mt-6">
          <p className={`${styles.paragraph} sm:mr-[5rem] mr-5 text-base`}>{Content.heroSectionInfo1}</p>
        </div>
        <div className="w-full md:mt-10 mt-6">
          <p className={`${styles.paragraph} ss:text-left text-right sm:ml-[2.5rem] ml-5 text-base`}>{Content.heroSectionInfo2}</p>
        </div>
      </div>
