...
const FirstContactWidget = () => {
  return (
    <section className='panel1 w-[100%] py-5'>
    <div className={`flex-1 flex-wrap ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-col justify-center items-start max-w-[650px] h-[250px]">
          ...
          {Content.contactPanelTitle1} <br/>
          </h1>
          <p className="font-poppins text-base paragraph">{Content.contactPanelInfo1}</p>
...
export default FirstContactWidget